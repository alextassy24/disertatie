			...
			<section class="container w-full px-10 py-16 mx-auto md:w-3/4">
				...
				<LoadingWrapper :loading="loading">
					<div v-if="userData">
						...
						<div class="mb-8">
							<h2 class="subtitle">
								{{ translatedValues.wearers }}
							</h2>
							<div
								v-if="userData.wearers.length > 0"
								class="flex items-center gap-1"
							>
								<span>
									{{ translatedValues.you }}
								</span>
								<Tooltip :text="translatedValues.tooltipWearer">
									<router-link
										to="/my-wearers"
						...
						<div class="mb-8">
							...
							<div
								v-if="userData.products.length > 0"
								class="flex items-center gap-1"
							>
								<span>
									{{ translatedValues.you }}
...
<script setup>
	...
	const translatedValues = computed(() => {
		return {
			...
			tooltipWearer: t("profile.TooltipWearers"),
			tooltipProduct: t("profile.TooltipProducts"),
		};
	});
