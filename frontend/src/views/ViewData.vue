					...
					<div>
						...
						<table class="text-center divide-y divide-gray-200">
							...
							<tbody class="bg-white divide-y divide-gray-200">
								<tr v-for="item in gpsData" :key="item.index" class="align-middle">
									<td class="table-data">{{ item.date }}</td>
									<td class="table-data">{{ item.time }}</td>
									<td class="table-data">{{ item.latitude }}° N</td>
									<td class="table-data">{{ item.longitude }}° E</td>
									<td class="table-data">
...
const connection = new HubConnectionBuilder()
	.withUrl("http://127.0.0.1:5088/ws/gps-hub")
