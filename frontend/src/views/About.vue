        ...
        <section class="px-10 py-16">
            <div class="container mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="order-1">
                        <img :src="gpsPhoto" alt="" class="w-3/4 md:w-[200px] md:h-[200px] mx-auto mb-5 md:mb-0 rounded-xl">
                    </div>
                    <div class="order-2">
                        <h1 class="mb-5 text-4xl font-bold">{{ translatedValues.developmentTeam }}</h1>
                        <div class="mb-5">
                            <h2 class="mb-3 text-2xl font-bold">{{ translatedValues.coordinator }}</h2>
                            <p>Prof. Dr. Ing. Nicolae Ionescu</p>
                        </div>
                        <div>
                            <h2 class="mb-3 text-2xl font-bold">{{ translatedValues.students }}</h2>
                            <p>Gabriela Bucur</p>
            ...
            <div class="container mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="order-2 text-white md:order-1">
                        <h1 class="mb-5 text-4xl font-bold">{{ translatedValues.aboutProject }}</h1>
                        <p class="text-xl text-justify">{{ translatedValues.description }}</p>
                    </div>
                </div>
            </div>
        </section>
