        ...
        <div class="mt-28">
            ...
            <section class="container w-full px-10 py-16 mx-auto md:w-3/4 ">
                ...
                <div v-if="products.length > 0">
                    <PaginatedTable :headers="headers" :items="products" :page="page" :action="toggleModal" :link="link"
                        :item-page="itemPage" />
                ...
                <div v-else>
                    ...
                    <div class="flex items-center justify-between w-full gap-3 mx-auto mt-8 md:w-1/2">
                        ...
                        <router-link to="/register-product" class="flex items-center gap-2 btn">
...
const headers = ref(['Nr. Crt.', translatedValues.value.serialNumber, 'GUID', translatedValues.value.wearer, '', ''])
